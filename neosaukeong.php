...
<body>
    ...
    <nav class="navbar1">
        <div class="wrapper">
            <div class="ul2">
                <a href="NeoSauKeongAttendance.php" class="nav1-links">
                    <i class="iconify" data-icon="mdi:table-clock" style="font-size: 41px"></i>
                </a>
            </div>
            <div class="ul2">
                <a href="logout.php" class="nav1-links">
                    <i class="iconify" data-icon="mdi:logout" style="font-size: 36px"></i>
                </a>
            </div>
        </div>
    </nav>
                        ...
                        <div class="modal-body p-0">
                            ...
                            <fieldset id="tab021">
                                <form action="jobassignst.php" method="post">
                                    <div class="techupdate-details"></div>
                                </form>
                                <script type="text/javascript">
                                    $(document).ready(function() {
                                            $('.card').click(function() {
