                        ...
                        <div class="nav__dropdown">
                            ...
                            <div class="nav__dropdown-collapse">
                                <div class="nav__dropdown-content">
                                    ...
                                    <a href="#" class="nav__dropdown-item" style="white-space: nowrap;">Acessories In/Out</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="jobRegisterContainer">
                ...
                <div class="listAddForm">
                    ...
                    <div class="contentListAddForm">
                        <form id="user_form" method="post">
                            <div class="listAddForm-details"> <?php if (isset($_SESSION["username"])) ?> <div class="input-box">
                    ...
                    <div class="contentListAddForm">
                        <form id="jobForm" method="post">
                            <div class="listAddForm-details">
                                ...
                                </div> <?php if (isset($_SESSION["username"])) ?> <input type="hidden" name="jobtypecreated_by" id="jobtypecreated_by" value="<?php echo $_SESSION["username"] ?>" readonly>
                            ...
                            if (brandname != '' || brandname == '') {
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        ...
                                        console.log(res);
                                        if (res.success == true) $('#messageBrand').html('<span style="color: green">New Machine Brand Added!</span>');
                                        else $('#messageBrand').html('<span style="color: red">Failed to Insert Data !</span>');
                                    }
                                });
                            }
                        }
                               ...
                               type_name != '' || type_name == '') {
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        var res = JSON.parse(response);
                                        console.log(res);
                                        if (res.success == true) $('#messageType').html('<span style="color: green">New Machine Type Added!</span>');
                                        else $('#messageType').html('<span style="color: red">Failed to Insert Data !</span>');
                                    }
                                });
                            }
                        }
                            ...
                            <div class="contentTechJobInfo">
                                ...
                                <form action="" method="post">
                                    <div class="machine-register">
                                        ...
                                        <script>$(document).ready(function() {$("#NamaCustomer").select2();});</script>
                        ...
                        if (str.length == 0) {
                            ...
                            xmlhttp.onreadystatechange = function() {
                                if (this.readyState == 4 && this.status == 200) {
                                    ...
                                    document.getElementById("CustomerNameInput").value = myObj[0];
                                }
                            };
                    ...
                    function submitMachine() {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                var res = JSON.parse(response);
                                console.log(res);
                                if (res.success == true) $('#messageMachine').html('<span style="color: green">Succesfully Registered Machine!</span>');
                                else $('#messageMachine').html('<span style="color: red">Failed to Insert Data !</span>');
                            }
                        });
                        }
                    }
            ...
            <form action="jobregisterindex.php" method="post">
                ...
                <div id="jobInfo2">
                            ...
                            <select id="jobModel" onchange="GetJob(this.value)">
                                <option value="">-- Select Job --</option> 
                                    <?php 
                                        ...
                                        $records = mysqli_query($conn, "SELECT job_code, job_name From jobtype_list ORDER BY jobtypelastmodify_at DESC");
                    ...
                    <div class="input-box">
                        <label for="JobDescription" class="details">Job Description</label>
                        <textarea name="job_description" id="job_description" placeholder="Enter Job Description" rows="5" cols="119" required></textarea>
                    </div>
                ...
                <div id="jobInfo3">
                    ...
                    <div class="input-box">
                        <label for="MachineDescription" class="details">Machine Description</label>
                        <textarea name="machine_description" id="DescriptionMachine" placeholder="Enter Machine Description" rows="5" cols="119"></textarea>
                        <div class="CodeDropdown">
                            <label for="Accessories Required" class="details">Accessories Required</label><br />
                            <select type="text" id="accessories_required" name="accessories_required" onchange="myFunctionAccessory()">
                    ...
                    <!--Acessory For-->
                    <div class="input-box">
                    <div id="Accessory" class="CodeDropdown">
                        <label for="Accessory" class="details">Accessory For</label><br />
                        <select type="text" id="accessories_for" name="accessories_for">
