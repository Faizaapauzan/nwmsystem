        ...
        <section>
            ...
            <div class="modal fade" id="brandEditModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Update Machine Brand</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form id="updateBrand">
                            <div class="modal-body">
            ...
            <div class="modal fade" id="deleteConfirmationModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p style="text-align: center;">Are you sure you want to delete this machine brand?</p>
                        </div>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <h4>Machine Brand<button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#brandAddModal">Add</button></h4>
                </div>

                <div class="card-body">
                    <div class="table-responsive">
                        <table id="machineBrandTable" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th style='text-align: center;'>No</th>
                                    <th style='text-align: center; white-space: nowrap;'>Machine Brand</th>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $query = "SELECT * FROM machine_brand ORDER BY brandname";
                                ...
                                <tr>
                                    ...
                                    <td style='text-align: center; white-space: nowrap;'><?= $brand['brandname'] ?></td>
                                    <td style='text-align: center; white-space: nowrap;'>
                                        <button type="button" value="<?= $brand['brand_id']; ?>" class="editMachBrandBtn btn btn-success btn-sm">Update</button>
                                        <button type="button" value="<?= $brand['brand_id']; ?>" class="deleteMachBrandBtn btn btn-danger btn-sm">Delete</button>
                                    </td>
                                </tr>
                                <?php $counter++; } } ?>
                            </tbody>
            ...
            <script>
                // <!-- Add New Machine -->
                $(document).on('submit', '#saveMachineBrand', function(e) {
                    e.preventDefault();

                    var form = $(this);
                    var formData = new FormData(form[0]);
                        formData.append('save_brandName', true);

                    console.log([...formData.entries()]);

                    $.ajax({
                        type: "POST",
                        url: "machineBrandCode.php",
                        data: formData,
                        dataType: "json",
                        processData: false,
                        contentType: false,
                ...
                // <!-- Update -->
                $(document).on('click', '.editMachBrandBtn', function() {
                    var brand_id = $(this).val();

                    $.ajax({
                        type: "GET",
                        url: "machineBrandCode.php?brand_id=" + brand_id,
                ...
                $(document).on('submit', '#updateBrand', function(e) {
                    e.preventDefault();

                    var formData = new FormData(this);
                    formData.append("update_machBrand", true);
                ...
                // <!-- Delete -->
                $(document).on('click', '.deleteMachBrandBtn', function() {
                    var brand_id = $(this).val();

                    $('#confirmDeleteBtn').val(brand_id);
