...
<div class="example" style="text-align: end; padding-bottom: 10px;" >
    ...
    <div class="column">
			...
			<?php
				...
				$results = $conn->query("SELECT jobregister_id, job_order_number, job_priority, job_name, customer_name,
				customer_grade, job_status, job_description, machine_name, machine_type, serialnumber, reason, staff_position, job_assign FROM job_register WHERE
