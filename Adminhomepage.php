                ...
                <div class="box" id="myModal">
                    <div class="box_topic">Store</div>
                            ...
                            <?php
                                include 'dbconnect.php';
                                $results = $conn->query("SELECT * FROM job_register WHERE
                                                        (accessories_required = 'Yes' AND job_status = 'NULL' AND job_cancel = ''
                                                            OR
                                                         staff_position = 'Storekeeper' AND job_status = 'NULL' AND job_cancel = ''
                                                            OR
                                                         ...
                                                         ORDER BY jobregisterlastmodify_at DESC LIMIT 50");	 
                                $numRow = "SELECT * FROM job_register WHERE
                                                   (accessories_required = 'Yes' AND job_status = 'NULL' AND job_cancel = 'NULL'
                                                        OR
                                                    staff_position = 'Storekeeper' AND job_status = 'NULL' AND job_cancel = 'NULL'
                                                        OR
                                                    accessories_required = 'Yes' AND job_status = 'Not Ready' AND job_cancel = 'NULL'
                                                        OR
                                                    staff_position = 'Storekeeper' AND job_status = 'Not Ready' AND job_cancel = 'NULL'
                                                        OR
                                                    staff_position = 'Storekeeper' AND job_status = 'Incomplete' AND job_cancel = 'NULL'
                                                        OR
                                                    staff_position = 'Storekeeper' AND job_status = 'Pending' AND job_cancel = 'NULL')";
                                $numRow_run = mysqli_query ($conn,$numRow);
                                if ($row_Total = mysqli_num_rows($numRow_run)) {
                                    echo '<h4 style="text-align:right;" >Total Job: '.$row_Total.' </h4>';
                                }
...
<!-- Incomplete VIDEO Tab -->
                        ...
                        <div class="left-side">
                            <div class="box_topic">Hamir</div>
                                    ...
                                    <?php
                                        include 'dbconnect.php';
                                        $results = $conn->query("SELECT * FROM job_register WHERE
                                                                (job_assign = 'Hamir' AND job_status = 'NULL' AND job_cancel = 'NULL'
                                                                    OR
                                                                 job_assign = 'Hamir' AND job_status = 'Doing' AND job_cancel = 'NULL'
                                                                    OR
                                                                 job_assign = 'Hamir' AND job_status = 'Ready' AND job_cancel = 'NULL'
                                                                    OR
                                                                 job_assign = 'Hamir' AND job_status = 'Pending' AND job_cancel = 'NULL')
                                                                 ORDER BY jobregisterlastmodify_at DESC LIMIT 50");
                                        $numRow = "SELECT * FROM `job_register`WHERE
                                                            job_assign = 'Hamir' AND job_status = 'NULL' AND job_cancel = 'NULL'
                                                                OR
        ...
        <!-- HWA -->
            ...
            $results = $conn->query("SELECT * FROM job_register WHERE
                (job_assign = 'Hwa' AND job_status = 'NULL' AND job_cancel = 'NULL'
                OR
                job_assign = 'Hwa' AND job_status = 'Doing' AND job_cancel = 'NULL'
                OR
                job_assign = 'Hwa' AND job_status = 'Ready' AND job_cancel = 'NULL'
                OR
                job_assign = 'Hwa' AND job_status = 'Pending' AND job_cancel = 'NULL')
            ...
            <div class="Hwa" data-type_id="<?php echo $row['type_id'];?>" data-id="<?php echo $row['jobregister_id'];?>" data-target="doubleClick-Hwa"  ondblclick="document.getElementById('doubleClick-Hwa').style.display='block'">
            <input type="hidden" name="jobregister_id" id="jobregister_id" value="<?php echo $row['jobregister_id'] ?>" readonly>
            <ul class="b" id="draged">
            <strong text-align="center"><?php echo $row['job_order_number']?></strong>
            <li><?php echo $row['job_priority']?></li>
    ...
    <div class="tabHwa">
        ...
        <label for="tabDoingHwa3" class="tabHeadingHwa">Job Assign</label>
        <div class="tab" id="HwaJobInfoTab">
        <div class="techClose" data-dismiss="modal" onclick="document.getElementById('doubleClick-Hwa').style.display='none'">&times</div>
        <form action="jobassignADMIN.php" method="post">
        ...
        <script type='text/javascript'>
            ...
            <!-- ISK -->
                ...
                $results = $conn->query("SELECT * FROM job_register WHERE
                        (job_assign = 'ISKANDAR' AND job_status = 'NULL' AND job_cancel = 'NULL'
                        OR
                        job_assign = 'ISKANDAR' AND job_status = 'Doing' AND job_cancel = 'NULL'
                        OR
                        job_assign = 'ISKANDAR' AND job_status = 'Ready' AND job_cancel = 'NULL'
                        OR
                        job_assign = 'ISKANDAR' AND job_status = 'Pending' AND job_cancel = 'NULL')
                        ORDER BY jobregisterlastmodify_at
                        DESC LIMIT 50");
                ...
                <div class="Isk" data-type_id="<?php echo $row['type_id'];?>" data-id="<?php echo $row['jobregister_id'];?>" data-target="doubleClick-Isk" ondblclick="document.getElementById('doubleClick-Isk').style.display='block'">
                <input type="hidden" name="jobregister_id" id="jobregister_id" value="<?php echo $row['jobregister_id'] ?>" readonly>
                <ul class="b" id="draged">
                <strong text-align="center"><?php echo $row['job_order_number']?></strong>
                <li><?php echo $row['job_priority']?></li>
    ...
    <div class="tabIsk">
        ...
        <label for="tabDoingIsk3" class="tabHeadingIsk">Job Assign</label>
        <div class="tab" id="IskJobInfoTab">
        <div class="techClose" data-dismiss="modal" onclick="document.getElementById('doubleClick-Isk').style.display='none'">&times</div>
        <form action="jobassignADMIN.php" method="post">
        ...
        <script type='text/javascript'>
            ...
            $('#doubleClick-Isk').modal('show');
                ...
                $results = $conn->query("SELECT * FROM job_register WHERE
                        (job_assign = 'John' AND job_status = 'NULL' AND job_cancel = 'NULL'
                        OR
                        job_assign = 'John' AND job_status = 'Doing' AND job_cancel = 'NULL'
                        OR
                        job_assign = 'John' AND job_status = 'Ready' AND job_cancel = 'NULL'
                        OR
                        job_assign = 'John' AND job_status = 'Pending' AND job_cancel = 'NULL')
                        ORDER BY jobregisterlastmodify_at
                        DESC LIMIT 50");
                ...
                <div class="John" data-type_id="<?php echo $row['type_id'];?>" data-id="<?php echo $row['jobregister_id'];?>" data-target="doubleClick-John" ondblclick="document.getElementById('doubleClick-John').style.display='block'">
                <input type="hidden" name="jobregister_id" id="jobregister_id" value="<?php echo $row['jobregister_id'] ?>" readonly>
                <ul class="b" id="draged">
                <strong text-align="center"><?php echo $row['job_order_number']?></strong>
                <li><?php echo $row['job_priority']?></li>
    ...
    <div class="tabJohn">
        ...
        <label for="tabDoingJohn3" class="tabHeadingJohn">Job Assign</label>
        <div class="tab" id=JohnJobInfoTab>
        <div class="techClose" data-dismiss="modal" onclick="document.getElementById('doubleClick-John').style.display='none'">&times</div>
        <form action="jobassignADMIN.php" method="post">
 ...
 <!--Double click Video-->
        ...
        <script type='text/javascript'>
            ...
            <?php
                include 'dbconnect.php';                
                $results = $conn->query("SELECT * FROM job_register WHERE
                        (job_assign = 'Jun Jie' AND job_status = 'NULL' AND job_cancel = 'NULL'
                        OR
                        job_assign = 'Jun Jie' AND job_status = 'Doing' AND job_cancel = 'NULL'
                        OR
                        job_assign = 'Jun Jie' AND job_status = 'Ready' AND job_cancel = 'NULL'
                        OR
                        job_assign = 'Jun Jie' AND job_status = 'Pending' AND job_cancel = 'NULL')
                        ORDER BY jobregisterlastmodify_at
                        DESC LIMIT 50");
                ...
                <div class="JunJie" data-type_id="<?php echo $row['type_id'];?>" data-id="<?php echo $row['jobregister_id'];?>" data-target="doubleClick-JunJie" ondblclick="document.getElementById('doubleClick-JunJie').style.display='block'">
                <input type="hidden" name="jobregister_id" id="jobregister_id" value="<?php echo $row['jobregister_id'] ?>" readonly>
                <ul class="b" id="draged">
                <strong text-align="center"><?php echo $row['job_order_number']?></strong>
                <li><?php echo $row['job_priority']?></li>
        ...
        <label for="tabDoingJunJie3" class="tabHeadingJunJie">Job Assign</label>
        <div class="tab" id=JunJieJobInfoTab>
        <div class="techClose" data-dismiss="modal" onclick="document.getElementById('doubleClick-JunJie').style.display='none'">&times</div>
        <form action="jobassignADMIN.php" method="post">
        ...
        <script type='text/javascript'>
            ...
            $('#doubleClick-JunJie').modal('show');
                ...
                <?php
                    include 'dbconnect.php';
                    $results = $conn->query("SELECT * FROM job_register WHERE
                            (job_assign = 'Will' AND job_status = 'NULL' AND job_cancel = 'NULL'
                            OR
                            job_assign = 'Will' AND job_status = 'Doing' AND job_cancel = 'NULL'
                            OR
                            job_assign = 'Will' AND job_status = 'Ready' AND job_cancel = 'NULL'
                            OR
                            job_assign = 'Will' AND job_status = 'Pending' AND job_cancel = 'NULL')
                            ORDER BY jobregisterlastmodify_at
                            DESC LIMIT 50");
                ...
                <div class="Razwill" data-type_id="<?php echo $row['type_id'];?>" data-id="<?php echo $row['jobregister_id'];?>" data-target="doubleClick-Razwill" ondblclick="document.getElementById('doubleClick-Razwill').style.display='block'">
                <input type="hidden" name="jobregister_id" id="jobregister_id" value="<?php echo $row['jobregister_id'] ?>" readonly>
                <ul class="b" id="draged">
                <strong text-align="center"><?php echo $row['job_order_number']?></strong>
                <li><?php echo $row['job_priority']?></li>
        ...
        <label for="tabDoingRazwill3" class="tabHeadingRazwill">Job Assign</label>
        <div class="tab" id=RazwillJobInfoTab>
        <div class="techClose" data-dismiss="modal" onclick="document.getElementById('doubleClick-Razwill').style.display='none'">&times</div>
        <form action="jobassignADMIN.php" method="post">
        ...
        <script type='text/javascript'>
            ...
            $('#doubleClick-Razwill').modal('show');
                ...
                <?php
                    include 'dbconnect.php';
                    $results = $conn->query("SELECT * FROM job_register WHERE
                            (job_assign = 'Sahele' AND job_status = 'NULL' AND job_cancel = 'NULL'
                            OR
                            job_assign = 'Sahele' AND job_status = 'Doing' AND job_cancel = 'NULL'
                            OR
                            job_assign = 'Sahele' AND job_status = 'Ready' AND job_cancel = 'NULL'
                            OR
                            job_assign = 'Sahele' AND job_status = 'Pending' AND job_cancel = 'NULL')
                            ORDER BY jobregisterlastmodify_at
                            DESC LIMIT 50");
                ...
                <div class="Sahele" data-type_id="<?php echo $row['type_id'];?>" data-id="<?php echo $row['jobregister_id'];?>" data-target="doubleClick-Sahele"  ondblclick="document.getElementById('doubleClick-Sahele').style.display='block'">
                <input type="hidden" name="jobregister_id" id="jobregister_id" value="<?php echo $row['jobregister_id'] ?>" readonly>
                <ul class="b" id="draged">
                <strong text-align="center"><?php echo $row['job_order_number']?></strong>
                <li><?php echo $row['job_priority']?></li>
        ...
        <label for="tabDoingSahele3" class="tabHeadingSahele">Job Assign</label>
        <div class="tab" id="SaheleJobInfoTab">
        <div class="techClose" data-dismiss="modal" onclick="document.getElementById('doubleClick-Sahele').style.display='none'">&times</div>
        <form action="jobassignADMIN.php" method="post">
        ...
        <script type='text/javascript'>
            ...
            $('#doubleClick-Sahele').modal('show');
                ...
                <?php
                 include 'dbconnect.php';
                $results = $conn->query("SELECT * FROM job_register WHERE
                        (job_assign = 'Sazaly' AND job_status = 'NULL' AND job_cancel = 'NULL'
                        OR
                        job_assign = 'Sazaly' AND job_status = 'Doing' AND job_cancel = 'NULL'
                         OR
                        job_assign = 'Sazaly' AND job_status = 'Ready' AND job_cancel = 'NULL'
                        OR
                        job_assign = 'Sazaly' AND job_status = 'Pending' AND job_cancel = 'NULL')
                        ORDER BY jobregisterlastmodify_at
                        DESC LIMIT 50");
                ...
                <div class="Sazaly" data-type_id="<?php echo $row['type_id'];?>" data-id="<?php echo $row['jobregister_id'];?>" data-target="doubleClick-Sazaly"  ondblclick="document.getElementById('doubleClick-Sazaly').style.display='block'">
                <input type="hidden" name="jobregister_id" id="jobregister_id" value="<?php echo $row['jobregister_id'] ?>" readonly>
                <ul class="b" id="draged">
                <strong text-align="center"><?php echo $row['job_order_number']?></strong>
                <li><?php echo $row['job_priority']?></li>
        ...
        <label for="tabDoingSazaly3" class="tabHeadingSazaly">Job Assign</label>
        <div class="tab" id="SazalyJobInfoTab">
        <div class="techClose" data-dismiss="modal" onclick="document.getElementById('doubleClick-Sazaly').style.display='none'">&times</div>
        <form action="jobassignADMIN.php" method="post">
        ...
        <script type='text/javascript'>
            ...
            include 'dbconnect.php';
            $results = $conn->query("SELECT * FROM job_register WHERE
                    (job_assign = 'Faizan' AND job_status = 'NULL' AND job_cancel = 'NULL'
                    OR
                    job_assign = 'Faizan' AND job_status = 'Doing' AND job_cancel = 'NULL'
                    OR
                    job_assign = 'Faizan' AND job_status = 'Ready' AND job_cancel = 'NULL'
                    OR
                    job_assign = 'Faizan' AND job_status = 'Pending' AND job_cancel = 'NULL')
                    ORDER BY jobregisterlastmodify_at
                    DESC LIMIT 50");
            ...
            <div class="Faizan" data-type_id="<?php echo $row['type_id'];?>" data-id="<?php echo $row['jobregister_id'];?>" data-target="doubleClick-Faizan"  ondblclick="document.getElementById('doubleClick-Faizan').style.display='block'">
            <input type="hidden" name="jobregister_id" id="jobregister_id" value="<?php echo $row['jobregister_id'] ?>" readonly>
            <ul class="b" id="draged">
            <strong text-align="center"><?php echo $row['job_order_number']?></strong>
            <li><?php echo $row['job_priority']?></li>
    ...
    <div class="tabFaizan">
        ...
        <label for="tabDoingFaizan3" class="tabHeadingFaizan">Job Assign</label>
        <div class="tab" id="FaizanJobInfoTab">
        <div class="techClose" data-dismiss="modal" onclick="document.getElementById('doubleClick-Faizan').style.display='none'">&times</div>
        <form action="jobassignADMIN.php" method="post">
        ...
        <script type='text/javascript'>
            ...
            include 'dbconnect.php';
            $results = $conn->query("SELECT * FROM job_register WHERE
                    (job_assign = 'Fauzin' AND job_status = 'NULL' AND job_cancel = 'NULL'
                    OR
                    job_assign = 'Fauzin' AND job_status = 'Doing' AND job_cancel = 'NULL'
                    OR
                    job_assign = 'Fauzin' AND job_status = 'Ready' AND job_cancel = 'NULL'
                    OR
                    job_assign = 'Fauzin' AND job_status = 'Pending' AND job_cancel = 'NULL')
                    ORDER BY jobregisterlastmodify_at
                    DESC LIMIT 50");
            ...
            <div class="Fauzin" data-type_id="<?php echo $row['type_id'];?>" data-id="<?php echo $row['jobregister_id'];?>" ondblclick="document.getElementById('doubleClick-Fauzin').style.display='block'">
            <input type="hidden" name="jobregister_id" id="jobregister_id" value="<?php echo $row['jobregister_id'] ?>" readonly>
            <ul class="b" id="draged">
            <strong text-align="center"><?php echo $row['job_order_number']?></strong>
            <li><?php echo $row['job_priority']?></li>
        ...
        <label for="tabDoingFauzin3" class="tabHeadingFauzin">Job Assign</label>
        <div class="tab" id="FauzinJobInfoTab">
        <div class="techClose" data-dismiss="modal" onclick="document.getElementById('doubleClick-Fauzin').style.display='none'">&times</div>
        <form action="jobassignADMIN.php" method="post">
...
<!-- IZAAN -->
            ...
            $results = $conn->query("SELECT * FROM job_register WHERE
                    (job_assign = 'Izaan' AND job_status = 'NULL' AND job_cancel = 'NULL'
                    OR
                    job_assign = 'Izaan' AND job_status = 'Doing' AND job_cancel = 'NULL'
                    OR
                    job_assign = 'Izaan' AND job_status = 'Ready' AND job_cancel = 'NULL'
                    OR
                    job_assign = 'Izaan' AND job_status = 'Pending' AND job_cancel = 'NULL')
                    ORDER BY jobregisterlastmodify_at
                    DESC LIMIT 50");
           ...
           job_assign = 'Izaan' AND job_status = 'NULL' AND job_cancel = 'NULL'
            ...
            <div class="Izaan" data-type_id="<?php echo $row['type_id'];?>" data-id="<?php echo $row['jobregister_id'];?>" data-target="doubleClick-Izaan"  ondblclick="document.getElementById('doubleClick-Izaan').style.display='block'">
            <input type="hidden" name="jobregister_id" id="jobregister_id" value="<?php echo $row['jobregister_id'] ?>" readonly>
            <ul class="b" id="draged">
            <strong text-align="center"><?php echo $row['job_order_number']?></strong>
            <li><?php echo $row['job_priority']?></li>
        ...
        <label for="tabDoingIzaan3" class="tabHeadingIzaan">Job Assign</label>
        <div class="tab" id="IzaanJobInfoTab">
        <div class="techClose" data-dismiss="modal" onclick="document.getElementById('doubleClick-Izaan').style.display='none'">&times</div>
        <form action="jobassignADMIN.php" method="post">
        ...
        <script type='text/javascript'>
            ...
            $results = $conn->query("SELECT * FROM job_register WHERE
                    (job_assign = 'Salam' AND job_status = 'NULL' AND job_cancel = 'NULL'
                    OR
                    job_assign = 'Salam' AND job_status = 'Doing' AND job_cancel = 'NULL'
                    OR
                    job_assign = 'Salam' AND job_status = 'Ready' AND job_cancel = 'NULL'
                    OR
                    job_assign = 'Salam' AND job_status = 'Pending' AND job_cancel = 'NULL')
                    ORDER BY jobregisterlastmodify_at
                    DESC LIMIT 50");

            $numRow = "SELECT * FROM `job_register`WHERE 
            job_assign = 'Salam' AND job_status = 'NULL'
                    OR
            ...
            <div class="Salam" data-type_id="<?php echo $row['type_id'];?>" data-id="<?php echo $row['jobregister_id'];?>" data-target="doubleClick-Salam" ondblclick="document.getElementById('doubleClick-Salam').style.display='block'">
            <input type="hidden" name="jobregister_id" id="jobregister_id" value="<?php echo $row['jobregister_id'] ?>" readonly>
            <ul class="b" id="draged">
            <strong text-align="center"><?php echo $row['job_order_number']?></strong>
            <li><?php echo $row['job_priority']?></li>
        ...
        <label for="tabDoingSalam3" class="tabHeadingSalam">Job Assign</label>
        <div class="tab" id="SalamJobInfoTab">
        <div class="techClose" data-dismiss="modal" onclick="document.getElementById('doubleClick-Salam').style.display='none'">&times</div>
        <form action="jobassignADMIN.php" method="post">
        <div class="salam-assign">
 ...
 <!--Double click Video-->
        ...
        <script type='text/javascript'>
            ...
            $results = $conn->query("SELECT * FROM job_register WHERE
                    (job_assign = 'Teck' AND job_status = 'NULL' AND job_cancel = 'NULL'
                    OR
                    job_assign = 'Teck' AND job_status = 'Doing' AND job_cancel = 'NULL'
                    OR
                    job_assign = 'Teck' AND job_status = 'Ready' AND job_cancel = 'NULL'
                    OR
                    job_assign = 'Teck' AND job_status = 'Pending' AND job_cancel = 'NULL')
                    ORDER BY jobregisterlastmodify_at
                    DESC LIMIT 50");
            ...
            <div class="Teck" data-type_id="<?php echo $row['type_id'];?>" data-id="<?php echo $row['jobregister_id'];?>" data-target="doubleClick-Teck"  ondblclick="document.getElementById('doubleClick-Teck').style.display='block'">
            <input type="hidden" name="jobregister_id" id="jobregister_id" value="<?php echo $row['jobregister_id'] ?>" readonly>
            <ul class="b" id="draged">
            <strong text-align="center"><?php echo $row['job_order_number']?></strong>
            <li><?php echo $row['job_priority']?></li>
    ...
    <div class="tabTeck">
        ...
        <label for="tabDoingTeck3" class="tabHeadingTeck">Job Assign</label>
        <div class="tab" id="TeckJobInfoTab">
        <div class="techClose" data-dismiss="modal" onclick="document.getElementById('doubleClick-Teck').style.display='none'">&times</div>
        <form action="jobassignADMIN.php" method="post">
        ...
        <script type='text/javascript'>
            ...
            $results = $conn->query("SELECT * FROM job_register WHERE
                    (job_assign = 'Aizat' AND job_status = 'NULL' AND job_cancel = 'NULL'
                    OR
                    job_assign = 'Aizat' AND job_status = 'Doing' AND job_cancel = 'NULL'
                    OR
                    job_assign = 'Aizat' AND job_status = 'Ready' AND job_cancel = 'NULL'
                    OR
                    job_assign = 'Aizat' AND job_status = 'Pending' AND job_cancel = 'NULL')
                    ORDER BY jobregisterlastmodify_at
                    DESC LIMIT 50");

            $numRow = "SELECT * FROM `job_register`WHERE 
            job_assign = 'Aizat' AND job_status = 'NULL'
                    OR
            ...
            <div class="Aizat" data-type_id="<?php echo $row['type_id'];?>" data-id="<?php echo $row['jobregister_id'];?>" data-target="doubleClick-Aizat" ondblclick="document.getElementById('doubleClick-Aizat').style.display='block'">
            <input type="hidden" name="jobregister_id" id="jobregister_id" value="<?php echo $row['jobregister_id'] ?>" readonly>
            <ul class="b" id="draged">
            <strong text-align="center"><?php echo $row['job_order_number']?></strong>
            <li><?php echo $row['job_priority']?></li>
                    ...
                    <div class="left-side" >
                        <div class="box_topic">Boon</div>
                                ...
                                <?php
                                    include 'dbconnect.php';
                                    $results = $conn->query("SELECT * FROM job_register WHERE
                                                            (job_assign = 'Boon' AND job_status = 'NULL' AND job_cancel = 'NULL'
                                                                OR
                                                             job_assign = 'Boon' AND job_status = 'Doing' AND job_cancel = 'NULL' 
                                                                OR
                                                             job_assign = 'Boon' AND job_status = 'Ready' AND job_cancel = 'NULL'
                                                                OR
                                                             job_assign = 'Boon' AND job_status = 'Pending' AND job_cancel = 'NULL')
                                                            ORDER BY jobregisterlastmodify_at DESC LIMIT 50");
                                    $numRow = "SELECT * FROM `job_register`WHERE 
                                                        job_assign = 'Boon' AND job_status = 'NULL' AND job_cancel = 'NULL'
                                                            OR
                    ...
                    <div class="left-side">
                        <div class="box_topic">Hafiz</div>
                                ...
                                <?php
                                    include 'dbconnect.php';
                                    $results = $conn->query("SELECT * FROM job_register WHERE
                                                            (job_assign = 'Hafiz' AND job_status = 'NULL' AND job_cancel = 'NULL'
                                                                OR
                                                             job_assign = 'Hafiz' AND job_status = 'Doing' AND job_cancel = 'NULL'
                                                                OR
                                                             job_assign = 'Hafiz' AND job_status = 'Ready' AND job_cancel = 'NULL'
                                                                OR
                                                             job_assign = 'Hafiz' AND job_status = 'Pending' AND job_cancel = 'NULL')
                                                             ORDER BY jobregisterlastmodify_at DESC LIMIT 50");
                                    $numRow = "SELECT * FROM `job_register`WHERE 
                                                        job_assign = 'Hafiz' AND job_status = 'NULL' AND job_cancel = 'NULL'
                                                            OR
