...
<input type="hidden" name="staff_position" id='staff_position' value="<?php echo $row['staff_position']?>" readonly>      
 ...
 <div class="col-md-6">
    ...
    <select disabled class="form-control" id="jobassistantto1" onchange="GetAssistant(this.value)">
  ...
  <div class="col-md-6">
    ...
    <select disabled class="form-control" id="jobassistantto2" onchange="GetAssistant(this.value)">
  ...
  <div class="col-md-6">
    ...
    <select disabled class="form-control" id="jobassistantto3" onchange="GetAssistant(this.value)">
  ...
  <div class="col-md-6">
    ...
    <select disabled class="form-control" id="jobassistantto4" onchange="GetAssistant(this.value)">
