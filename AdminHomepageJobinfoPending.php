                ...
                if (today_date != '' || today_date == '',
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (res.success == true) 
                                $('#messageDuplicatelist').html('<span style="color: green">Job Duplicated Successfully!</span>');
                            else 
                                $('#messageDuplicatelist').html('<span style="color: red">Job cannot be duplicated</span>');
                        }
                    });
                }
            }
