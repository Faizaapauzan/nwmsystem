...
<body>
	...
	<form id="techstatus_form" method="post">
		...
		<div class="form-group">
			...
			<select class="form-control" style="width:704px; height:50px; font-size:15px;" type="text" id="job_status" name="job_status" onchange="myFunction()">
		...
		<div id="reason" class="form-group row" style="margin-top:10px; width:100%; margin-left:4px">
