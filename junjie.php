...
if(!isset($_SESSION['username']))
    ...
    elseif($_SESSION["username"]="JUN JIE")
	{
...
<body>
  ...
  <?php
            ...
            <div class="column">
              ...
              job_register
              WHERE
              (job_assign = 'Jun Jie' AND job_status = 'Completed')
              ORDER BY jobregisterlastmodify_at
              DESC LIMIT 50");
              while($row = $results->fetch_assoc()) {
 ...
 <div id="doubleClick-1" class="modal">
  ...
  <div class="tab" id=jobInfoTabs>
    ...
    <label for="tabDoingThree" class="tabHeading"> Remarks </label>
    <div class="tab">
      <div class="TechJobInfoTab">
          <div class="contentTechJobInfo">
            <div class="techClose" data-dismiss="modal" onclick="document.getElementById('doubleClick-1').style.display='none'">&times</div>
...
<input type="radio" name="tabDoing" id="tabDoingFour">
    <label for="tabDoingFour" class="tabHeading"> Report </label>
    <div class="tab">
      <div class="TechJobInfoTab">
          <div class="contentTechJobInfo">
            <div class="techClose" data-dismiss="modal" onclick="document.getElementById('doubleClick-1').style.display='none'">&times</div>
...
$(document).ready(function() {
    ...
    <label for="tabDoingFive" class="tabHeading"> Accessories </label>
    <div class="tab">
      <div class="TechJobInfoTab">
          <div class="contentTechJobInfo">
            <div class="techClose" data-dismiss="modal" onclick="document.getElementById('doubleClick-1').style.display='none'">&times</div>
...
<input type="radio" name="tabDoing" id="tabDoingSix">
    <label for="tabDoingSix" class="tabHeading"> Media </label>
    <div class="tab">
      <div class="TechJobInfoTab">
          <div class="contentTechJobInfo">
            <div class="techClose" data-dismiss="modal" onclick="document.getElementById('doubleClick-1').style.display='none'">&times</div>
...
$(document).ready(function() {
    $('.card').click(function() {
      ...
      <input type="radio" name="tabDoing" id="tabDoingSeven">
    <label for="tabDoingSeven" class="tabHeading">Job Status</label>
    <div class="tab" id=jobInfoTabs>
    <div class="TechJobInfoTab">
        <div class="contentTechJobInfo">
            <div class="techClose" data-dismiss="modal" onclick="document.getElementById('doubleClick-1').style.display='none'">&times</div>
