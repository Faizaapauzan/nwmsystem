...
<body> 
    ...
    <form action="AdminHomepageJobinfoStorekeeperIndex.php" method="post" style=" display: contents;">
        ...
        <div class="input-box" style="width: 100%;">
            <label for="accessories_for">Acessories For:</label>
            <select id="accessories_for" name="accessories_for">
