...
<html lang="en">
    <body>
        ...
        ?> 
        <form action="AdminHomepageJobinfoStorekeeperIndex.php" method="post" class="mx-3" id="jobinfoStore">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="job_order_number" value="<?php echo $row['job_order_number']?>" class="form-control">
                </div>
