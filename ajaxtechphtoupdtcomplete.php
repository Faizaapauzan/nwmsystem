            ...
            <table style="box-shadow: 0 5px 10px #f7f7f7;">
              <tbody style="display: flex; flex-wrap: wrap;">
                ...
                <tr style="display:grid; padding-left: 25px;">
                  ...
                  <td style='text-align: center;'><span class='deleted' style="color:red; cursor: pointer; font-weight:bold;" data-id='<?php echo $res["id"]; ?>'>Delete</span></td>
                </tr> 
                <?php endforeach;?>
              </tbody>
            </table>
          ...
          <div class="table-responsive">
            <table style="box-shadow: 0 5px 10px #f7f7f7;">
              <tbody style="display: flex; flex-wrap: wrap;">
                ...
                <tr style="display:grid; padding-left: 25px;">
                  <td><a href="image/<?php echo $res['file_name']; ?>" download><img src="<?php echo 'image/'.$res['file_name']; ?>" id="display_image"></td>
                  <td style='text-align: center;'><span class='deleted' data-id='<?php echo $res["id"]; ?>' style="color:red; cursor: pointer; font-weight:bold;">Delete</span></td>
                </tr>
                <?php endforeach;?>
              </tbody>
            </table>
