        ...
        <section>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Add New Machine Brand</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form id="saveMachineType">
                                        ...
                                        <?php
                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    echo "<option value='" . $row['brand_id'] . "'>" . $row['brandname'] . "</option>";
                                                }
                                            }
                                        ?>
                                    </select>
                                ...
                                <script>
                                    $(document).ready(function() {
                                        $.fn.select2.amd.require(['select2/compat/matcher'], function (oldMatcher) {
                                            $("#brand_id").select2({
                                                dropdownParent: $('#saveMachineType'),
            ...
            <div class="modal fade" id="brandEditModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Update Machine Type</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form id="updateType">
                            <div class="modal-body">
                                <div class="container">
                                    ...
                                    <div class="mb-3">
                                        <label for="">Machine Brand</label>
                                        <select name="brand_id" id="brandID" class="form-select">
                                            <option value="">Select Machine Brand</option>
                                                <?php
            ...
            <div class="modal fade" id="deleteConfirmationModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p style="text-align: center;">Are you sure you want to delete this machine type?</p>
                        </div>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <h4>Machine Type<button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#typeAddModal">Add</button></h4>
                </div>

                <div class="card-body">
                    <div class="table-responsive">
                        <table id="machineTypeTable" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th style='text-align: center;'>No</th>
                                    <th style='text-align: center; white-space: nowrap;'>Machine Type</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style='text-align: center; white-space: nowrap;'><?= $type['type_name'] ?></td>
                                    <td style='text-align: center; white-space: nowrap;'>
                                        <button type="button" value="<?= $type['type_id']; ?>" class="editMachTypeBtn btn btn-success btn-sm">Update</button>
                                        <button type="button" value="<?= $type['type_id']; ?>" class="deleteMachTypeBtn btn btn-danger btn-sm">Delete</button>
                                    </td>
                                </tr>
                                <?php $counter++; } } ?>
                            </tbody>
            ...
            <script>
                // <!-- Add New Machine -->
                $(document).on('submit', '#saveMachineType', function(e) {
                    e.preventDefault();

                    var form = $(this);
                    var formData = new FormData(form[0]);
                        formData.append('save_typeName', true);

                    console.log([...formData.entries()]);

                    $.ajax({
                        type: "POST",
                        url: "machineTypeCode.php",
                        data: formData,
                        dataType: "json",
                        processData: false,
                        contentType: false,
                ...
                // <!-- Update -->
                $(document).on('click', '.editMachTypeBtn', function() {
                    var type_id = $(this).val();

                    $.ajax({
                        type: "GET",
                        url: "machineTypeCode.php?type_id=" + type_id,
                        success: function(response) {
                            ...
                            if (res.status == 404) {
                                ...
                                $('#brandID').val(res.data.brand_id).trigger('change');
                ...
                $(document).on('submit', '#updateType', function(e) {
                    ...
                    formData.append("update_machType", true);
                ...
                // <!-- Delete -->
                $(document).on('click', '.deleteMachTypeBtn', function() {
                    var type_id = $(this).val();

                    $('#confirmDeleteBtn').val(type_id);
