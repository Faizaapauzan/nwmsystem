...
<html lang="en">
    ...
    <body>
        <div class="my-5 page" size="A4">
                        ...
                        <div class="position-relative"><br/><br/>
                            <center>
                                <div class="SR">Service Report</div>
                                    <div class="text-center"></div>
                                        ...
                                        <script type="text/javascript">
                                            function number(){
                                                $.ajax({
                                                    url:"servicereportnumber.php", success:function(result){
                                ...
                                <form action="servicereportindex.php" method="post">
                                    <div class="SRno">
                                        Service Report No:<input type="text" name="srvcreportnumber" id="numbreport" value="" class="serviceno">
                                    </div>
                            </center>
                        </div>
                    </div>
                ...
                <?php } } }?>
                                    ...
                                    <div class="rightside">
                                        ...
                                        ?>
                                            ...
                                            <p><label>Serial Number :</label><span><input type="text" name="serialnumber" value="<?php echo $row['serialnumber'] ?>" class="input"/></span></p><br/>
                                            ...
                                            <?php
                                                ...
                                                if (isset($_POST['jobregister_id'])) {
                                                    ...
                                                    $results = $conn->query("SELECT * FROM job_register 
                                                                             ...
                                                                             OR jobregister_id='$jobregister_id' AND support IS NULL AND tech_out !=''");
                                ...
                                <div class="try3">
                                    ...
                                    <textarea name="report" 
                                              style="writing-mode: horizontal-tb !important;
                                                     font-family: Arial;
                                                     text-rendering: auto;
                                                     text-align: start;
                                                     cursor: text;
            ...
            <div>
                <input type="button" onclick="submitForm();" id="print-btn" value="Save">
            </div>
