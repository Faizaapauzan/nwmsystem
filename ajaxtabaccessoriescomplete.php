...
<form id="adminacc_form" method="post">
        <div class="input-boxAccessories" id="input_fields_wrapAccessories">
          ...
          <div class="updateBtn">
            ...
            <input style="width: 210px;" type="button" id="update_acc" name="update_acc" value="Update"/>
      </form>
      ...
      <script type="text/javascript">
          $(document).ready(function () {
            ...
            `<div class="field-element"> <div class="model">
             ...
             <a href="javascript:void(0);" class="remove_button" title="Add field">Remove</a></div></div>`; //New input field html
