 ...
 <form action="supportindex.php" method="post" class="row g-3">
   ...
   <div class="col-md-6">
    ...
    <div style="margin-left: 365px;margin-top: 20px;" class="updateBtn">
     <button type="button" id="duplicate" style="background-color: #081d45; border-color: #081d45;" class="btn btn-primary" name="duplicate" value="duplicate" onclick="submitFormSupport();">Request</button>
    </div>
