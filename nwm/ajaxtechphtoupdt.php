...
/*Remark*/
  ...
  .input-boxPhoto i:hover,
  .input-boxPhoto i:focus {
    opacity: 0.8;
    cursor: pointer;
  }
...
<td><span class='updated' data-id='<?php echo $res["id"]; ?>'>Update</span></td>
         <td><span class='deleted' data-id='<?php echo $res["id"]; ?>'>Delete</span></td>
      </tr>
	  <?php endforeach;?>
   </tbody>
</table>
...
<select style="border-color: #081d45; border-radius: 5px; padding-left: 25px; border: 1px solid #ccc; border-bottom-width: 2px; padding: 0 15px 0 15px; height: 25px; outline: none; font-size: 16px;" name='description[<?=$row['id']?>]'>
<option value='' <?php if ($row['description'] == '') { echo "SELECTED"; } ?>></option>
<option value="Machine (Before Service)" <?php if ($row['description'] == "Machine (Before Service)") { echo "SELECTED";} ?>>Machine (Before Service)</option>
<option value="Accessories (Broken)" <?php if ($row['description'] == "Accessories (Broken)") { echo "SELECTED"; } ?>>Accessories (Broken)</option>
<option value="Accessories (New)" <?php if ($row['description'] == "Accessories (New)") { echo "SELECTED"; } ?>>Accessories (New)</option>
<option value="Machine (After Service)" <?php if ($row['description'] == "Machine (After Service)") { echo "SELECTED"; } ?>>Machine (After Service)</option>
</select>
