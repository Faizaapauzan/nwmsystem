...
<input type="text" class="remark_desc" name="remark_desc[]" value="<?php echo $row['remark_desc'] ?>" placeholder="Enter Problem">
<input type="text" class="remark_solution" name="remark_solution[]" value="<?php echo $row['remark_solution'] ?>" placeholder="Enter Solution">
<br></div>
