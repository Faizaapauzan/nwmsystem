    ...
    <input type="hidden" name="jobregister_id" class="jobregister_id" value="<?php echo $row['jobregister_id'] ?>">
     <div class="input-box">
        ...
        <div class="input-box">
            ...
            <select id="job_assign" name="job_assign">
                ...
                <option value="Aizat" <?php if ($row['job_assign'] == "Aizat") {
                    echo "SELECTED";
                } ?>>Aizat</option>
                <option value="Faizan" <?php if ($row['job_assign'] == "Faizan") {
                    echo "SELECTED";
                } ?>>Faizan</option>
                <option value="Fauzin" <?php if ($row['job_assign'] == "Fauzin") {
                    echo "SELECTED";
                } ?>>Fauzin</option>
                <option value="Izaan" <?php if ($row['job_assign'] == "Izaan") {
                    echo "SELECTED";
                } ?>>Izaan</option>
                <option value="Salam" <?php if ($row['job_assign'] == "Salam") {
                    echo "SELECTED";
                } ?>>Salam</option>
        ...
        <div class="input-box">
            ...
            <select id="Job_assistant" name="Job_assistant">
        ...
        <div class="input-box">
            ...
            <textarea name="job_description" class="job_description" rows="3" cols="20"><?php echo $row['job_description']?></textarea>
        </div>
