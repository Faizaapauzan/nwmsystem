...
$sql = "INSERT INTO staff_register (staffregister_id, username, password, staff_fullname, employee_id,
     staff_phone, staff_email, staff_department, staff_position, staff_group, technician_group,
	 staffregistercreated_by, staffregistercreated_at,
     staffregisterlastmodify_by, staffregisterlastmodify_at)

					
VALUES ('default', '$username', '$password', '$staff_fullname', '$employee_id',
    '$staff_phone', '$staff_email', '$staff_department', '$staff_position', '$staff_group', ' $technician_group', '$staffregistercreated_by',
