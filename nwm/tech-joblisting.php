...
#job-list {
  border-top: 5px solid #081d45;
}

#list-pending {
  border-top: 5px solid #0f3a8a;
}
...
<body>
    ...
    <section class="home-section">
        ...
        <div class="sidebar-button">
            ...
            <a href="tech.php"><span class="dashboard">HOME</span></a>
          </div>
          <div class="sidebar-button">
        ...
        <div class="container">
          <div class="column">
            <p class="column-title" id="job-list">Job Listing</p>
                   ...
                   <?php
                    ...
                    OR
                    job_assign = '' AND job_status = 'Doing'
                    OR
            ...
            <div class="column" >
              <p class="column-title"id="list-pending" >Pending</p>
