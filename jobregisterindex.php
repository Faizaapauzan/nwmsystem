...
include 'dbconnect.php';
	...
	$sql = "INSERT INTO job_register (today_date, job_code, job_name, job_order_number, job_description, job_assign, customer_code,
...
VALUES ('".addslashes($_POST['today_date'])."',
        ...
        '".addslashes($_POST['job_description'])."', '$job_assign',
