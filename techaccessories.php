...
<body>
                ...
                <script>
                    $('#addrow').click(function() {
                        ...
                        var newrow = $('<div class="row">' 
                                        +'<div><input type="text" name="inout_id[]" id="inout_id' + i + '" class="dynamic-row-inout-id"></div>' 
    ...
    <div class="modal fade" id="entryViewModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">View Accessory On Hand</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (res.status == 404) {
                        ...
                        $('#view_remarknote').text(res.data.remark_note);
                        $('#view_remarkdate').text(res.data.remark_date);
                        $('#view_remarkquatity').text(res.data.remark_quantity);
