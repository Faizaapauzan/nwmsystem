        ...
        <div class="input-box-out">
            ...
            <form id="TechnicianRestHourOut">
                <div style="display: flex; align-items: baseline;">
                    ...
                    <input type="text" style="width: 406.5px;" id="tech_out" name="tech_out" value="<?php echo $row['tech_out']?>">
            ...
            <form id="TechnicianRestHourIn">
                <div style="display: flex; align-items: baseline;">
                    ...
                    <input type="text" style="width: 408px;" id="tech_in" name="tech_in" value="<?php echo $row['tech_in']?>">
